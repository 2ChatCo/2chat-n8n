    ...
    properties: [
      {
        ...
        options: [
          ...
          },
          {
            ...
            description: 'Triggers when a phone call status changes (e.g., ringing, answered, ended)',
					...
					{
            name: 'WABA Message Received',
            value: 'whatsapp.waba.message.received',
            description: 'Triggers when a WABA message is received on your 2Chat connected number',
          },
					{
            name: 'WABA Message Sent',
            value: 'whatsapp.waba.message.sent',
            description: 'Triggers when a WABA message is sent from your 2Chat connected number',
          },
          {
        ...
        displayOptions: {
            ...
            event: [
							...
							'call.status.update',
							'whatsapp.waba.message.received',
							'whatsapp.waba.message.sent'
						],
					}
				},
        typeOptions: {
      ...
      },
      {
        ...
        default: '',
        description: 'Limit the triggers to this WABA Number. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
      },
			{
