...
### WABA Resource
- **Send Message**: Send WABA messages to individual contacts
	- Support for text messages

- **Send Template Message**: Send WABA template messages to individual contacts
  - Support for template messages

- **Send Interactive Message**: Send WABA interactive messages to individual contacts
...
- **WhatsApp Message Events:** Listen for message events
  ...
  - Reaction Received: Triggers when a WhatsApp message is reacted to.

- **WhatsApp Business API Events**: Listen for WhatsApp Business API events
	- WABA Message Received: Triggers when a new WABA message is received
	- WABA Message Sent: Triggers when a new WABA message is sent
